            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        AI-Powered resume <br /> made <span className="font-subheading italic">simple</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Transform Your Job Search with AI-Powered Automation. Create tailored resumes faster, optimize content for specific job roles, and make smarter career decisions—all in minutes with myjobb Resume AI.
                    </p>
                </div>
            </Container>
